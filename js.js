...
window.onload = function() {
    if (itemId && detailsData[itemId]) {
        ...
        document.body.innerHTML = "<div style='text-align:center; color:white; margin-top:50px;'><h1>يرجى اعادة تحميل الصفحة هناك خطأ!!!!!!  </h1><a href='kbh_page.html' style='color:cyan;'>الرجوع الى الموقع </a></div>";
    }
};